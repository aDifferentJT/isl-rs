...
use libc::uintptr_t;
use crate::bindings::{DimType, Stat, BasicMap, Id, Set, MultiPwAff, Context, MultiAff, Val, Space, FixedBox, PwMultiAff, MultiId, Constraint, StrideInfo, MapList, Aff, PwAff, BasicMapList};
...
extern "C" {
    ...
    fn isl_map_order_gt(map: uintptr_t, type1: DimType, pos1: i32, type2: DimType, pos2: i32) -> uintptr_t;
    ...
    fn isl_map_set_dim_name(map: uintptr_t, type_: DimType, pos: u32, s: *const c_char) -> uintptr_t;

    fn isl_map_oppose(map: uintptr_t, type1: DimType, pos1: i32, type2: DimType, pos2: i32) -> uintptr_t;
    ...
    fn isl_map_equate(map: uintptr_t, type1: DimType, pos1: i32, type2: DimType, pos2: i32) -> uintptr_t;
    ...
    fn isl_map_upper_bound_val(map: uintptr_t, type_: DimType, pos: u32, value: uintptr_t) -> uintptr_t;
    ...
    fn isl_map_order_ge(map: uintptr_t, type1: DimType, pos1: i32, type2: DimType, pos2: i32) -> uintptr_t;
    ...
    fn isl_map_foreach_basic_map(map: uintptr_t, fn_: unsafe extern "C" fn(uintptr_t, *mut c_void) -> Stat, user: *mut c_void) -> Stat;
    ...
    fn isl_map_drop_constraints_not_involving_dims(map: uintptr_t, type_: DimType, first: u32, n: u32) -> uintptr_t;
    ...
    fn isl_map_lower_bound_val(map: uintptr_t, type_: DimType, pos: u32, value: uintptr_t) -> uintptr_t;
    ...
    fn isl_map_order_lt(map: uintptr_t, type1: DimType, pos1: i32, type2: DimType, pos2: i32) -> uintptr_t;
    ...
    fn isl_map_order_le(map: uintptr_t, type1: DimType, pos1: i32, type2: DimType, pos2: i32) -> uintptr_t;
    ...
    fn isl_map_remove_divs_involving_dims(map: uintptr_t, type_: DimType, first: u32, n: u32) -> uintptr_t;
    ...
    fn isl_map_move_dims(map: uintptr_t, dst_type: DimType, dst_pos: u32, src_type: DimType, src_pos: u32, n: u32) -> uintptr_t;
    ...
    fn isl_map_drop_constraints_involving_dims(map: uintptr_t, type_: DimType, first: u32, n: u32) -> uintptr_t;
...
impl Map {
    ...
    pub fn get_range_stride_info(&self, pos: i32) -> StrideInfo {
        ...
        let isl_rs_result = StrideInfo { ptr: isl_rs_result, should_free_on_drop: true };
        isl_rs_result
    }
    ...
    pub fn to_list(self) -> MapList {
        ...
        let isl_rs_result = MapList { ptr: isl_rs_result, should_free_on_drop: true };
        isl_rs_result
    }
    ...
    /// Wraps `isl_map_foreach_basic_map`.
    pub fn foreach_basic_map<fn_>(&self, mut fn_: fn_, user: *mut c_void) -> Stat
    where fn_: FnMut(&BasicMap) -> Stat,
    {
        let context_for_error_message = self.get_ctx();
        let map = self;
        let map = map.ptr;
        ...
        let isl_rs_result = unsafe { isl_map_foreach_basic_map(map, fn_, user) };
        isl_rs_result
    }
    ...
    pub fn drop_constraints_not_involving_dims(self, type_: DimType, first: u32, n: u32) -> Map {
        ...
        map.do_not_free_on_drop();
        let map = map.ptr;
        let isl_rs_result = unsafe { isl_map_drop_constraints_not_involving_dims(map, type_, first, n) };
        if isl_rs_result == 0 {
            panic!("ISL error: {}", context_for_error_message.last_error_msg());
        }
        let isl_rs_result = Map { ptr: isl_rs_result, should_free_on_drop: true };
    ...
    pub fn move_dims(self, dst_type: DimType, dst_pos: u32, src_type: DimType, src_pos: u32, n: u32) -> Map {
        let context_for_error_message = self.get_ctx();
        let map = self;
        let mut map = map;
        map.do_not_free_on_drop();
        let map = map.ptr;
        let isl_rs_result = unsafe { isl_map_move_dims(map, dst_type, dst_pos, src_type, src_pos, n) };
        if isl_rs_result == 0 {
            panic!("ISL error: {}", context_for_error_message.last_error_msg());
        }
        let isl_rs_result = Map { ptr: isl_rs_result, should_free_on_drop: true };
    ...
    pub fn drop_constraints_involving_dims(self, type_: DimType, first: u32, n: u32) -> Map {
        ...
        map.do_not_free_on_drop();
        let map = map.ptr;
        let isl_rs_result = unsafe { isl_map_drop_constraints_involving_dims(map, type_, first, n) };
        if isl_rs_result == 0 {
            panic!("ISL error: {}", context_for_error_message.last_error_msg());
        }
        let isl_rs_result = Map { ptr: isl_rs_result, should_free_on_drop: true };
