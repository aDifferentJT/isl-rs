...
use libc::uintptr_t;
use crate::bindings::{DimType, Stat, UnionSet, Aff, Space, Set, Context, Id, UnionPwMultiAff, PwAff, Val, PwAffList, UnionPwAffList};
...
extern "C" {
    ...
    fn isl_union_pw_aff_find_dim_by_name(upa: uintptr_t, type_: DimType, name: *const c_char) -> i32;
    ...
    fn isl_union_pw_aff_intersect_domain_wrapped_domain(upa: uintptr_t, uset: uintptr_t) -> uintptr_t;

    fn isl_union_pw_aff_set_dim_name(upa: uintptr_t, type_: DimType, pos: u32, s: *const c_char) -> uintptr_t;
    ...
    fn isl_union_pw_aff_every_pw_aff(upa: uintptr_t, test: unsafe extern "C" fn(uintptr_t, *mut c_void) -> i32, user: *mut c_void) -> i32;

    fn isl_union_pw_aff_intersect_domain_space(upa: uintptr_t, space: uintptr_t) -> uintptr_t;

    fn isl_union_pw_aff_intersect_domain_wrapped_range(upa: uintptr_t, uset: uintptr_t) -> uintptr_t;
    ...
    fn isl_union_pw_aff_foreach_pw_aff(upa: uintptr_t, fn_: unsafe extern "C" fn(uintptr_t, *mut c_void) -> Stat, user: *mut c_void) -> Stat;
...
impl UnionPwAff {
    ...
    pub fn every_pw_aff<test>(&self, mut test: test, user: *mut c_void) -> bool
    ...
    pub fn foreach_pw_aff<fn_>(&self, mut fn_: fn_, user: *mut c_void) -> Stat
...
impl Drop for UnionPwAff {
    fn drop(&mut self) {
        if self.should_free_on_drop {
            unsafe { isl_union_pw_aff_free(self.ptr); }
        }
    }
}