...
use libc::uintptr_t;
use crate::bindings::{DimType, UnionSet, UnionPwAff, PwAff, PwMultiAff, UnionPwMultiAff, Id, Space, MultiPwAff, MultiId, UnionMap, MultiVal, UnionPwAffList, Set, Val, Aff, MultiAff, Context};
...
extern "C" {
    ...
    fn isl_multi_union_pw_aff_pullback_union_pw_multi_aff(mupa: uintptr_t, upma: uintptr_t) -> uintptr_t;

    fn isl_multi_union_pw_aff_set_union_pw_aff(multi: uintptr_t, pos: i32, el: uintptr_t) -> uintptr_t;

    fn isl_multi_union_pw_aff_set_dim_id(multi: uintptr_t, type_: DimType, pos: u32, id: uintptr_t) -> uintptr_t;
    ...
    fn isl_multi_union_pw_aff_range_splice(multi1: uintptr_t, pos: u32, multi2: uintptr_t) -> uintptr_t;

    fn isl_multi_union_pw_aff_flat_range_product(multi1: uintptr_t, multi2: uintptr_t) -> uintptr_t;
    ...
    fn isl_multi_union_pw_aff_set_dim_name(multi: uintptr_t, type_: DimType, pos: u32, s: *const c_char) -> uintptr_t;
    ...
    fn isl_multi_union_pw_aff_set_tuple_id(multi: uintptr_t, type_: DimType, id: uintptr_t) -> uintptr_t;
    ...
    fn isl_multi_union_pw_aff_set_tuple_name(multi: uintptr_t, type_: DimType, s: *const c_char) -> uintptr_t;
    ...
    fn isl_multi_union_pw_aff_drop_dims(multi: uintptr_t, type_: DimType, first: u32, n: u32) -> uintptr_t;

    fn isl_multi_union_pw_aff_scale_val(multi: uintptr_t, v: uintptr_t) -> uintptr_t;

    fn isl_multi_union_pw_aff_find_dim_by_name(multi: uintptr_t, type_: DimType, name: *const c_char) -> i32;
    ...
    fn isl_multi_union_pw_aff_find_dim_by_id(multi: uintptr_t, type_: DimType, id: uintptr_t) -> i32;
    ...
    fn isl_multi_union_pw_aff_from_union_pw_aff_list(space: uintptr_t, list: uintptr_t) -> uintptr_t;

    fn isl_multi_union_pw_aff_get_ctx(multi: uintptr_t) -> uintptr_t;

    fn isl_multi_union_pw_aff_pw_multi_aff_on_domain(domain: uintptr_t, pma: uintptr_t) -> uintptr_t;
...
impl MultiUnionPwAff {
    ...
    pub fn pullback_union_pw_multi_aff(self, upma: UnionPwMultiAff) -> MultiUnionPwAff {
        ...
        let upma = upma.ptr;
        let isl_rs_result = unsafe { isl_multi_union_pw_aff_pullback_union_pw_multi_aff(mupa, upma) };
        if isl_rs_result == 0 {
            panic!("ISL error: {}", context_for_error_message.last_error_msg());
        }
        let isl_rs_result = MultiUnionPwAff { ptr: isl_rs_result, should_free_on_drop: true };
...
impl Drop for MultiUnionPwAff {
    fn drop(&mut self) {
        if self.should_free_on_drop {
            unsafe { isl_multi_union_pw_aff_free(self.ptr); }
        }
    }
}