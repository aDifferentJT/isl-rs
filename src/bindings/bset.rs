...
use libc::uintptr_t;
use crate::bindings::{DimType, Stat, Val, MultiAff, BasicMap, Constraint, Space, Mat, Set, Context, LocalSpace, Aff, Point, ConstraintList, Id};
...
extern "C" {
    ...
    fn isl_basic_set_lower_bound_val(bset: uintptr_t, type_: DimType, pos: u32, value: uintptr_t) -> uintptr_t;
    ...
    fn isl_basic_set_remove_divs_involving_dims(bset: uintptr_t, type_: DimType, first: u32, n: u32) -> uintptr_t;
    ...
    fn isl_basic_set_foreach_constraint(bset: uintptr_t, fn_: unsafe extern "C" fn(uintptr_t, *mut c_void) -> Stat, user: *mut c_void) -> Stat;

    fn isl_basic_set_coefficients(bset: uintptr_t) -> uintptr_t;

    fn isl_basic_set_upper_bound_val(bset: uintptr_t, type_: DimType, pos: u32, value: uintptr_t) -> uintptr_t;
    ...
    fn isl_basic_set_inequalities_matrix(bset: uintptr_t, c1: DimType, c2: DimType, c3: DimType, c4: DimType) -> uintptr_t;
    ...
    fn isl_basic_set_move_dims(bset: uintptr_t, dst_type: DimType, dst_pos: u32, src_type: DimType, src_pos: u32, n: u32) -> uintptr_t;
    ...
    fn isl_basic_set_drop_constraints_involving_dims(bset: uintptr_t, type_: DimType, first: u32, n: u32) -> uintptr_t;
    ...
    fn isl_basic_set_set_dim_name(bset: uintptr_t, type_: DimType, pos: u32, s: *const c_char) -> uintptr_t;

    fn isl_basic_set_equalities_matrix(bset: uintptr_t, c1: DimType, c2: DimType, c3: DimType, c4: DimType) -> uintptr_t;
    ...
    fn isl_basic_set_foreach_bound_pair(bset: uintptr_t, type_: DimType, pos: u32, fn_: unsafe extern "C" fn(uintptr_t, uintptr_t, uintptr_t, *mut c_void) -> Stat, user: *mut c_void) -> Stat;
    ...
    fn isl_basic_set_from_constraint_matrices(space: uintptr_t, eq: uintptr_t, ineq: uintptr_t, c1: DimType, c2: DimType, c3: DimType, c4: DimType) -> uintptr_t;
    ...
    fn isl_basic_set_drop_constraints_not_involving_dims(bset: uintptr_t, type_: DimType, first: u32, n: u32) -> uintptr_t;
...
impl BasicSet {
    ...
    pub fn remove_divs_involving_dims(self, type_: DimType, first: u32, n: u32) -> BasicSet {
        ...
        bset.do_not_free_on_drop();
        let bset = bset.ptr;
        let isl_rs_result = unsafe { isl_basic_set_remove_divs_involving_dims(bset, type_, first, n) };
        if isl_rs_result == 0 {
            panic!("ISL error: {}", context_for_error_message.last_error_msg());
        }
        let isl_rs_result = BasicSet { ptr: isl_rs_result, should_free_on_drop: true };
    ...
    pub fn move_dims(self, dst_type: DimType, dst_pos: u32, src_type: DimType, src_pos: u32, n: u32) -> BasicSet {
        ...
        bset.do_not_free_on_drop();
        let bset = bset.ptr;
        let isl_rs_result = unsafe { isl_basic_set_move_dims(bset, dst_type, dst_pos, src_type, src_pos, n) };
        if isl_rs_result == 0 {
            panic!("ISL error: {}", context_for_error_message.last_error_msg());
        }
        let isl_rs_result = BasicSet { ptr: isl_rs_result, should_free_on_drop: true };
    ...
    pub fn drop_constraints_involving_dims(self, type_: DimType, first: u32, n: u32) -> BasicSet {
        ...
        bset.do_not_free_on_drop();
        let bset = bset.ptr;
        let isl_rs_result = unsafe { isl_basic_set_drop_constraints_involving_dims(bset, type_, first, n) };
        if isl_rs_result == 0 {
            panic!("ISL error: {}", context_for_error_message.last_error_msg());
        }
        let isl_rs_result = BasicSet { ptr: isl_rs_result, should_free_on_drop: true };
    ...
    pub fn foreach_bound_pair<fn_>(&self, type_: DimType, pos: u32, mut fn_: fn_, user: *mut c_void) -> Stat
    where fn_: FnMut(&Constraint, &Constraint, &BasicSet) -> Stat,
    {
        let context_for_error_message = self.get_ctx();
        let bset = self;
        let bset = bset.ptr;
        extern "C" fn fn__wrapper<fn_>(arg_0: uintptr_t, arg_1: uintptr_t, arg_2: uintptr_t, arg_3: *mut c_void) -> Stat {
        ...
        let user: *mut c_void = unsafe { core::mem::transmute(user) };
        let fn_ = fn__wrapper::<fn_>;
        let isl_rs_result = unsafe { isl_basic_set_foreach_bound_pair(bset, type_, pos, fn_, user) };
        isl_rs_result
    }
    ...
    pub fn from_constraint_matrices(space: Space, eq: Mat, ineq: Mat, c1: DimType, c2: DimType, c3: DimType, c4: DimType) -> BasicSet {
        ...
        let ineq = ineq.ptr;
        let isl_rs_result = unsafe { isl_basic_set_from_constraint_matrices(space, eq, ineq, c1, c2, c3, c4) };
        if isl_rs_result == 0 {
            panic!("ISL error");
        }
        let isl_rs_result = BasicSet { ptr: isl_rs_result, should_free_on_drop: true };
    ...
    pub fn drop_constraints_not_involving_dims(self, type_: DimType, first: u32, n: u32) -> BasicSet {
        ...
        bset.do_not_free_on_drop();
        let bset = bset.ptr;
        let isl_rs_result = unsafe { isl_basic_set_drop_constraints_not_involving_dims(bset, type_, first, n) };
        if isl_rs_result == 0 {
            panic!("ISL error: {}", context_for_error_message.last_error_msg());
        }
        let isl_rs_result = BasicSet { ptr: isl_rs_result, should_free_on_drop: true };
