...
use libc::uintptr_t;
use crate::bindings::{DimType, Stat, Map, MultiId, Id, Val, Space, Context, MultiPwAff, FixedBox, PwMultiAff, Point, Constraint, BasicSet, IdList, BasicSetList, MultiAff, MultiVal, SetList, StrideInfo, PwAff};
...
extern "C" {
    ...
    fn isl_set_set_dim_name(set: uintptr_t, type_: DimType, pos: u32, s: *const c_char) -> uintptr_t;
    ...
    fn isl_set_equate(set: uintptr_t, type1: DimType, pos1: i32, type2: DimType, pos2: i32) -> uintptr_t;
    ...
    fn isl_set_move_dims(set: uintptr_t, dst_type: DimType, dst_pos: u32, src_type: DimType, src_pos: u32, n: u32) -> uintptr_t;
    ...
    fn isl_set_lower_bound_val(set: uintptr_t, type_: DimType, pos: u32, value: uintptr_t) -> uintptr_t;

    fn isl_set_get_hash(set: uintptr_t) -> u32;

    fn isl_set_drop_constraints_not_involving_dims(set: uintptr_t, type_: DimType, first: u32, n: u32) -> uintptr_t;

    fn isl_set_foreach_basic_set(set: uintptr_t, fn_: unsafe extern "C" fn(uintptr_t, *mut c_void) -> Stat, user: *mut c_void) -> Stat;

    fn isl_set_dim_max(set: uintptr_t, pos: i32) -> uintptr_t;

    fn isl_set_min_multi_pw_aff(set: uintptr_t) -> uintptr_t;

    fn isl_set_foreach_point(set: uintptr_t, fn_: unsafe extern "C" fn(uintptr_t, *mut c_void) -> Stat, user: *mut c_void) -> Stat;
    ...
    fn isl_set_drop_constraints_involving_dims(set: uintptr_t, type_: DimType, first: u32, n: u32) -> uintptr_t;
    ...
    fn isl_set_remove_divs_involving_dims(set: uintptr_t, type_: DimType, first: u32, n: u32) -> uintptr_t;
    ...
    fn isl_set_upper_bound_val(set: uintptr_t, type_: DimType, pos: u32, value: uintptr_t) -> uintptr_t;
...
impl Set {
    ...
    pub fn move_dims(self, dst_type: DimType, dst_pos: u32, src_type: DimType, src_pos: u32, n: u32) -> Set {
        ...
        set.do_not_free_on_drop();
        let set = set.ptr;
        let isl_rs_result = unsafe { isl_set_move_dims(set, dst_type, dst_pos, src_type, src_pos, n) };
        if isl_rs_result == 0 {
            panic!("ISL error: {}", context_for_error_message.last_error_msg());
        }
        let isl_rs_result = Set { ptr: isl_rs_result, should_free_on_drop: true };
    ...
    pub fn get_basic_set_list(&self) -> BasicSetList {
        ...
        let isl_rs_result = BasicSetList { ptr: isl_rs_result, should_free_on_drop: true };
        isl_rs_result
    }
    ...
    pub fn drop_constraints_not_involving_dims(self, type_: DimType, first: u32, n: u32) -> Set {
        ...
        set.do_not_free_on_drop();
        let set = set.ptr;
        let isl_rs_result = unsafe { isl_set_drop_constraints_not_involving_dims(set, type_, first, n) };
        if isl_rs_result == 0 {
            panic!("ISL error: {}", context_for_error_message.last_error_msg());
        }
        let isl_rs_result = Set { ptr: isl_rs_result, should_free_on_drop: true };
    ...
    /// Wraps `isl_set_foreach_basic_set`.
    pub fn foreach_basic_set<fn_>(&self, mut fn_: fn_, user: *mut c_void) -> Stat
    where fn_: FnMut(&BasicSet) -> Stat,
    {
        ...
        let isl_rs_result = unsafe { isl_set_foreach_basic_set(set, fn_, user) };
        isl_rs_result
    }
    ...
    /// Wraps `isl_set_foreach_point`.
    pub fn foreach_point<fn_>(&self, mut fn_: fn_, user: *mut c_void) -> Stat
    where fn_: FnMut(&Point) -> Stat,
    {
        let context_for_error_message = self.get_ctx();
        let set = self;
        let set = set.ptr;
        ...
        let user: *mut c_void = unsafe { core::mem::transmute(user) };
        let fn_ = fn__wrapper::<fn_>;
        let isl_rs_result = unsafe { isl_set_foreach_point(set, fn_, user) };
        isl_rs_result
    }
    ...
    pub fn drop_constraints_involving_dims(self, type_: DimType, first: u32, n: u32) -> Set {
        ...
        set.do_not_free_on_drop();
        let set = set.ptr;
        let isl_rs_result = unsafe { isl_set_drop_constraints_involving_dims(set, type_, first, n) };
        if isl_rs_result == 0 {
            panic!("ISL error: {}", context_for_error_message.last_error_msg());
        }
        let isl_rs_result = Set { ptr: isl_rs_result, should_free_on_drop: true };
