...
use crate::bindings::{
    BasicSet, BasicSetList, Constraint, Context, DimType, FixedBox, Id, IdList, Map, MultiAff,
    MultiId, MultiPwAff, MultiVal, Point, PwAff, PwMultiAff, SetList, Space, Stat, StrideInfo, Val,
};
use libc::uintptr_t;
...
extern "C" {
    ...
    fn isl_set_foreach_basic_set(set: uintptr_t,
    ...
    fn isl_set_foreach_point(set: uintptr_t,
                             fn_: unsafe extern "C" fn(uintptr_t, *mut c_void) -> Stat,
                             user: *mut c_void)
                             -> Stat;
...
impl Set {
    ...
    pub fn foreach_basic_set<fn_>(&self, fn_: fn_, user: *mut c_void) -> Stat
    ...
    pub fn foreach_point<fn_>(&self, fn_: fn_, user: *mut c_void) -> Stat
