...
use crate::bindings::{
    ...
    Space, Stat, UnionMap, UnionPwAff, UnionPwMultiAffList, UnionSet, Val,
};
use libc::uintptr_t;
...
extern "C" {
    ...
    fn isl_union_pw_multi_aff_foreach_pw_multi_aff(upma: uintptr_t,
    ...
    fn isl_union_pw_multi_aff_set_dim_name(upma: uintptr_t, type_: DimType, pos: u32,
                                           s: *const c_char)
                                           -> uintptr_t;
    ...
    fn isl_union_pw_multi_aff_drop_dims(upma: uintptr_t, type_: DimType, first: u32, n: u32)
                                        -> uintptr_t;
    ...
    fn isl_union_pw_multi_aff_every_pw_multi_aff(upma: uintptr_t,
    ...
    fn isl_union_pw_multi_aff_find_dim_by_name(upma: uintptr_t, type_: DimType,
                                               name: *const c_char)
                                               -> i32;
...
impl UnionPwMultiAff {
    ...
    pub fn foreach_pw_multi_aff<fn_>(&self, fn_: fn_, user: *mut c_void) -> Stat
    ...
    pub fn every_pw_multi_aff<test>(&self, test: test, user: *mut c_void) -> bool
