...
impl UnionSetList {
    ...
    pub fn map<fn_>(self, fn_: fn_, user: *mut c_void) -> UnionSetList
    ...
    pub fn sort<cmp>(self, cmp: cmp, user: *mut c_void) -> UnionSetList
              ...
              fn_: FnMut(&UnionSetList) -> Stat
    {
        ...
        extern "C" fn fn__wrapper<fn_>(arg_0: uintptr_t, arg_1: *mut c_void) -> Stat
            where fn_: FnMut(&UnionSetList) -> Stat
        {
            if arg_0 == 0 {
                panic!("ISL error");
            }
            let arg_0 = &UnionSetList { ptr: arg_0,
                                        should_free_on_drop: true };
            let fn_: *mut fn_ = unsafe { core::mem::transmute(arg_1) };
            let fn_: &mut fn_ = unsafe { &mut *fn_ };
            let res = fn_(arg_0);
