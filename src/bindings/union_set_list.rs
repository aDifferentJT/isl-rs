...
use crate::bindings::{Context, Stat, UnionSet};
use libc::uintptr_t;
...
extern "C" {
    ...
    fn isl_union_set_list_map(list: uintptr_t,
    ...
    fn isl_union_set_list_every(list: uintptr_t,
    ...
    fn isl_union_set_list_foreach_scc(list: uintptr_t,
    ...
    fn isl_union_set_list_sort(list: uintptr_t,
    ...
    fn isl_union_set_list_foreach(list: uintptr_t,
                                  fn_: unsafe extern "C" fn(uintptr_t, *mut c_void) -> Stat,
                                  user: *mut c_void)
                                  -> Stat;
...
impl UnionSetList {
    ...
    pub fn foreach_scc(&self,
        ...
        let list = list.ptr;
        let isl_rs_result =
            unsafe { isl_union_set_list_foreach_scc(list, follows, follows_user, fn_, fn_user) };
        isl_rs_result
    }
