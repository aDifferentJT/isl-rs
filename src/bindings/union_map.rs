...
use libc::uintptr_t;
use crate::bindings::{Stat, DimType, Map, MultiUnionPwAff, UnionSet, MultiPwAff, Context, PwMultiAff, BasicMap, Space, Val, MultiAff, UnionMapList, Set, MultiId, UnionPwMultiAff, Id, MapList};
...
extern "C" {
    ...
    fn isl_union_map_foreach_map(umap: uintptr_t, fn_: unsafe extern "C" fn(uintptr_t, *mut c_void) -> Stat, user: *mut c_void) -> Stat;
    ...
    fn isl_union_map_intersect_domain_factor_range(umap: uintptr_t, factor: uintptr_t) -> uintptr_t;
    ...
    fn isl_union_map_intersect_range_wrapped_domain_union_set(umap: uintptr_t, domain: uintptr_t) -> uintptr_t;
    ...
    fn isl_union_map_preimage_domain_union_pw_multi_aff(umap: uintptr_t, upma: uintptr_t) -> uintptr_t;

    fn isl_union_map_zip(umap: uintptr_t) -> uintptr_t;

    fn isl_union_map_remove_map_if(umap: uintptr_t, fn_: unsafe extern "C" fn(uintptr_t, *mut c_void) -> i32, user: *mut c_void) -> uintptr_t;
    ...
    fn isl_union_map_intersect_range_factor_domain(umap: uintptr_t, factor: uintptr_t) -> uintptr_t;
    ...
    fn isl_union_map_intersect_domain_factor_domain(umap: uintptr_t, factor: uintptr_t) -> uintptr_t;

    fn isl_union_map_intersect_domain_union_set(umap: uintptr_t, uset: uintptr_t) -> uintptr_t;

    fn isl_union_map_intersect_domain_wrapped_domain_union_set(umap: uintptr_t, domain: uintptr_t) -> uintptr_t;
    ...
    fn isl_union_map_every_map(umap: uintptr_t, test: unsafe extern "C" fn(uintptr_t, *mut c_void) -> i32, user: *mut c_void) -> i32;
    ...
    fn isl_union_map_preimage_range_union_pw_multi_aff(umap: uintptr_t, upma: uintptr_t) -> uintptr_t;
...
impl UnionMap {
    ...
    pub fn foreach_map<fn_>(&self, mut fn_: fn_, user: *mut c_void) -> Stat
    ...
    pub fn to_list(self) -> UnionMapList {
        ...
        let isl_rs_result = UnionMapList { ptr: isl_rs_result, should_free_on_drop: true };
        isl_rs_result
    }
    ...
    pub fn intersect_range_wrapped_domain_union_set(self, domain: UnionSet) -> UnionMap {
        ...
        domain.do_not_free_on_drop();
        let domain = domain.ptr;
        let isl_rs_result = unsafe { isl_union_map_intersect_range_wrapped_domain_union_set(umap, domain) };
        if isl_rs_result == 0 {
            panic!("ISL error: {}", context_for_error_message.last_error_msg());
        }
        let isl_rs_result = UnionMap { ptr: isl_rs_result, should_free_on_drop: true };
    ...
    pub fn remove_map_if<fn_>(self, mut fn_: fn_, user: *mut c_void) -> UnionMap
    where fn_: FnMut(&Map) -> bool,
    {
        let context_for_error_message = self.get_ctx();
        let umap = self;
        let mut umap = umap;
        umap.do_not_free_on_drop();
        let umap = umap.ptr;
        extern "C" fn fn__wrapper<fn_>(arg_0: uintptr_t, arg_1: *mut c_void) -> i32 {
            let fn_: *mut fn_ = unsafe { core::mem::transmute(arg_1) };
            let fn_: &mut fn_ = unsafe { &mut *fn_ };
            todo!()
        }
    ...
    pub fn intersect_domain_wrapped_domain_union_set(self, domain: UnionSet) -> UnionMap {
        ...
        domain.do_not_free_on_drop();
        let domain = domain.ptr;
        let isl_rs_result = unsafe { isl_union_map_intersect_domain_wrapped_domain_union_set(umap, domain) };
        if isl_rs_result == 0 {
            panic!("ISL error: {}", context_for_error_message.last_error_msg());
        }
        let isl_rs_result = UnionMap { ptr: isl_rs_result, should_free_on_drop: true };
    ...
    pub fn every_map<test>(&self, mut test: test, user: *mut c_void) -> bool
...
impl Drop for UnionMap {
    fn drop(&mut self) {
        if self.should_free_on_drop {
            unsafe { isl_union_map_free(self.ptr); }
        }
    }
}