...
impl UnionMap {
    ...
    pub fn foreach_map<fn_>(&self, fn_: fn_, user: *mut c_void) -> Stat
    ...
    pub fn remove_map_if<fn_>(self, fn_: fn_, user: *mut c_void) -> UnionMap
    ...
    pub fn every_map<test>(&self, test: test, user: *mut c_void) -> bool
