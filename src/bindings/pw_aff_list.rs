...
use crate::bindings::{Context, PwAff, Set, Stat};
use libc::uintptr_t;
...
extern "C" {
    ...
    fn isl_pw_aff_list_every(list: uintptr_t,
    ...
    fn isl_pw_aff_list_foreach(list: uintptr_t,
    ...
    fn isl_pw_aff_list_map(list: uintptr_t,
                           fn_: unsafe extern "C" fn(uintptr_t, *mut c_void) -> uintptr_t,
                           user: *mut c_void)
                           -> uintptr_t;

    fn isl_pw_aff_list_sort(list: uintptr_t,
    ...
    fn isl_pw_aff_list_foreach_scc(list: uintptr_t,
...
impl PwAffList {
    ...
    pub fn foreach_scc(&self,
        ...
        let list = list.ptr;
        let isl_rs_result =
            unsafe { isl_pw_aff_list_foreach_scc(list, follows, follows_user, fn_, fn_user) };
        isl_rs_result
    }
