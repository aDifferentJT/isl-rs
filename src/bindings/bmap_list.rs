...
use crate::bindings::{BasicMap, Context, Stat};
use libc::uintptr_t;
...
extern "C" {
    ...
    fn isl_basic_map_list_every(list: uintptr_t,
    ...
    fn isl_basic_map_list_foreach_scc(list: uintptr_t,
    ...
    fn isl_basic_map_list_sort(list: uintptr_t,
    ...
    fn isl_basic_map_list_foreach(list: uintptr_t,
                                  fn_: unsafe extern "C" fn(uintptr_t, *mut c_void) -> Stat,
                                  user: *mut c_void)
                                  -> Stat;

    fn isl_basic_map_list_map(list: uintptr_t,
...
impl BasicMapList {
              ...
              fn_: FnMut(&BasicMapList) -> Stat
    {
        ...
        extern "C" fn fn__wrapper<fn_>(arg_0: uintptr_t, arg_1: *mut c_void) -> Stat
            where fn_: FnMut(&BasicMapList) -> Stat
        {
            if arg_0 == 0 {
                panic!("ISL error");
            }
            let arg_0 = &BasicMapList { ptr: arg_0,
                                        should_free_on_drop: true };
        ...
        let isl_rs_result =
            unsafe { isl_basic_map_list_foreach_scc(list, follows, follows_user, fn_, fn_user) };
        isl_rs_result
    }

    /// Wraps `isl_basic_map_list_sort`.
    pub fn sort<cmp>(self, cmp: cmp, user: *mut c_void) -> BasicMapList
    ...
    pub fn map<fn_>(self, fn_: fn_, user: *mut c_void) -> BasicMapList
