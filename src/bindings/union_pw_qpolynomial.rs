...
impl UnionPwQPolynomial {
    ...
    pub fn fold_every_pw_qpolynomial_fold<test>(upwf: &UnionPwQPolynomialFold, test: test,
                                                user: *mut c_void)
                                                -> bool
    ...
    pub fn every_pw_qpolynomial<test>(&self, test: test, user: *mut c_void) -> bool
    ...
    pub fn foreach_pw_qpolynomial<fn_>(&self, fn_: fn_, user: *mut c_void) -> Stat
    ...
    pub fn fold_foreach_pw_qpolynomial_fold<fn_>(upwf: &UnionPwQPolynomialFold, fn_: fn_,
                                                 user: *mut c_void)
                                                 -> Stat
