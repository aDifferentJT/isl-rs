...
use libc::uintptr_t;
use crate::bindings::{DimType, Fold, Stat, Val, UnionPwQPolynomialFold, Point, Context, PwQPolynomial, Space, UnionSet, PwQPolynomialFoldList, PwQPolynomialFold, Set, PwQPolynomialList};
...
extern "C" {
    ...
    fn isl_union_pw_qpolynomial_find_dim_by_name(upwqp: uintptr_t, type_: DimType, name: *const c_char) -> i32;
    ...
    fn isl_union_pw_qpolynomial_extract_pw_qpolynomial(upwqp: uintptr_t, space: uintptr_t) -> uintptr_t;

    fn isl_union_pw_qpolynomial_subtract_domain_union_set(upwpq: uintptr_t, uset: uintptr_t) -> uintptr_t;
    ...
    fn isl_union_pw_qpolynomial_every_pw_qpolynomial(upwqp: uintptr_t, test: unsafe extern "C" fn(uintptr_t, *mut c_void) -> i32, user: *mut c_void) -> i32;
    ...
    fn isl_union_pw_qpolynomial_intersect_domain_wrapped_domain(upwpq: uintptr_t, uset: uintptr_t) -> uintptr_t;
    ...
    fn isl_union_pw_qpolynomial_intersect_domain_union_set(upwpq: uintptr_t, uset: uintptr_t) -> uintptr_t;
    ...
    fn isl_union_pw_qpolynomial_subtract_domain_space(upwpq: uintptr_t, space: uintptr_t) -> uintptr_t;
    ...
    fn isl_union_pw_qpolynomial_intersect_domain_wrapped_range(upwpq: uintptr_t, uset: uintptr_t) -> uintptr_t;

    fn isl_union_pw_qpolynomial_foreach_pw_qpolynomial(upwqp: uintptr_t, fn_: unsafe extern "C" fn(uintptr_t, *mut c_void) -> Stat, user: *mut c_void) -> Stat;
    ...
    fn isl_union_pw_qpolynomial_drop_dims(upwqp: uintptr_t, type_: DimType, first: u32, n: u32) -> uintptr_t;
    ...
    fn isl_union_pw_qpolynomial_intersect_domain_space(upwpq: uintptr_t, space: uintptr_t) -> uintptr_t;
    ...
    fn isl_union_pw_qpolynomial_set_dim_name(upwqp: uintptr_t, type_: DimType, pos: u32, s: *const c_char) -> uintptr_t;
...
impl UnionPwQPolynomial {
    ...
    pub fn to_polynomial(self, sign: i32) -> UnionPwQPolynomial {
        ...
        let isl_rs_result = UnionPwQPolynomial { ptr: isl_rs_result, should_free_on_drop: true };
        isl_rs_result
    }
    ...
    pub fn find_dim_by_name(&self, type_: DimType, name: &str) -> i32 {
        ...
        let isl_rs_result = unsafe { isl_union_pw_qpolynomial_find_dim_by_name(upwqp, type_, name) };
        isl_rs_result
    }
    ...
    pub fn fold_fold(upwf1: UnionPwQPolynomialFold, upwf2: UnionPwQPolynomialFold) -> UnionPwQPolynomialFold {
        let mut upwf1 = upwf1;
    ...
    pub fn extract_pw_qpolynomial(&self, space: Space) -> PwQPolynomial {
        ...
        let space = space.ptr;
        let isl_rs_result = unsafe { isl_union_pw_qpolynomial_extract_pw_qpolynomial(upwqp, space) };
        if isl_rs_result == 0 {
            panic!("ISL error: {}", context_for_error_message.last_error_msg());
        }
        let isl_rs_result = PwQPolynomial { ptr: isl_rs_result, should_free_on_drop: true };
        isl_rs_result
    }
    ...
    pub fn subtract_domain_union_set(self, uset: UnionSet) -> UnionPwQPolynomial {
        ...
        let uset = uset.ptr;
        let isl_rs_result = unsafe { isl_union_pw_qpolynomial_subtract_domain_union_set(upwpq, uset) };
        if isl_rs_result == 0 {
            panic!("ISL error: {}", context_for_error_message.last_error_msg());
        }
        let isl_rs_result = UnionPwQPolynomial { ptr: isl_rs_result, should_free_on_drop: true };
    ...
    pub fn fold_get_pw_qpolynomial_fold_list(upwf: &UnionPwQPolynomialFold) -> PwQPolynomialFoldList {
        let upwf = upwf.ptr;
    ...
    pub fn fold_subtract_domain(upwf: UnionPwQPolynomialFold, uset: UnionSet) -> UnionPwQPolynomialFold {
        let mut upwf = upwf;
        upwf.do_not_free_on_drop();
        let upwf = upwf.ptr;
        let mut uset = uset;
    ...
    pub fn fold_fold_pw_qpolynomial_fold(upwqp: UnionPwQPolynomialFold, pwqp: PwQPolynomialFold) -> UnionPwQPolynomialFold {
        let mut upwqp = upwqp;
        upwqp.do_not_free_on_drop();
        let upwqp = upwqp.ptr;
        let mut pwqp = pwqp;
    ...
    pub fn fold_subtract_domain_space(upwf: UnionPwQPolynomialFold, space: Space) -> UnionPwQPolynomialFold {
        let mut upwf = upwf;
        upwf.do_not_free_on_drop();
        let upwf = upwf.ptr;
        let mut space = space;
    ...
    pub fn fold_every_pw_qpolynomial_fold<test>(upwf: &UnionPwQPolynomialFold, mut test: test, user: *mut c_void) -> bool
    ...
    pub fn every_pw_qpolynomial<test>(&self, mut test: test, user: *mut c_void) -> bool
    where test: FnMut(&PwQPolynomial) -> bool,
    {
        let context_for_error_message = self.get_ctx();
        let upwqp = self;
        let upwqp = upwqp.ptr;
        ...
        let test_user: *mut c_void = unsafe { core::mem::transmute(test_user) };
        let test = test_wrapper::<test>;
        let isl_rs_result = unsafe { isl_union_pw_qpolynomial_every_pw_qpolynomial(upwqp, test, user) };
        let isl_rs_result = match isl_rs_result {
            0 => false,
            1 => true,
    ...
    pub fn intersect_domain_wrapped_domain(self, uset: UnionSet) -> UnionPwQPolynomial {
        ...
        uset.do_not_free_on_drop();
        let uset = uset.ptr;
        let isl_rs_result = unsafe { isl_union_pw_qpolynomial_intersect_domain_wrapped_domain(upwpq, uset) };
        if isl_rs_result == 0 {
            panic!("ISL error: {}", context_for_error_message.last_error_msg());
        }
        let isl_rs_result = UnionPwQPolynomial { ptr: isl_rs_result, should_free_on_drop: true };
    ...
    pub fn fold_intersect_domain_wrapped_domain(upwf: UnionPwQPolynomialFold, uset: UnionSet) -> UnionPwQPolynomialFold {
        let mut upwf = upwf;
        upwf.do_not_free_on_drop();
        let upwf = upwf.ptr;
        let mut uset = uset;
    ...
    pub fn get_pw_qpolynomial_list(&self) -> PwQPolynomialList {
        ...
        let isl_rs_result = PwQPolynomialList { ptr: isl_rs_result, should_free_on_drop: true };
        isl_rs_result
    }

    /// Wraps `isl_union_pw_qpolynomial_fold_intersect_domain_space`.
    pub fn fold_intersect_domain_space(upwf: UnionPwQPolynomialFold, space: Space) -> UnionPwQPolynomialFold {
        let mut upwf = upwf;
        upwf.do_not_free_on_drop();
        let upwf = upwf.ptr;
        let mut space = space;
    ...
    pub fn intersect_domain_union_set(self, uset: UnionSet) -> UnionPwQPolynomial {
        ...
        uset.do_not_free_on_drop();
        let uset = uset.ptr;
        let isl_rs_result = unsafe { isl_union_pw_qpolynomial_intersect_domain_union_set(upwpq, uset) };
        if isl_rs_result == 0 {
            panic!("ISL error: {}", context_for_error_message.last_error_msg());
        }
        let isl_rs_result = UnionPwQPolynomial { ptr: isl_rs_result, should_free_on_drop: true };
    ...
    pub fn fold_subtract_domain_union_set(upwf: UnionPwQPolynomialFold, uset: UnionSet) -> UnionPwQPolynomialFold {
        let mut upwf = upwf;
        upwf.do_not_free_on_drop();
        let upwf = upwf.ptr;
        let mut uset = uset;
    ...
    pub fn fold_drop_dims(upwf: UnionPwQPolynomialFold, type_: DimType, first: u32, n: u32) -> UnionPwQPolynomialFold {
        let mut upwf = upwf;
        upwf.do_not_free_on_drop();
        let upwf = upwf.ptr;
    ...
    pub fn intersect_domain_wrapped_range(self, uset: UnionSet) -> UnionPwQPolynomial {
        ...
        uset.do_not_free_on_drop();
        let uset = uset.ptr;
        let isl_rs_result = unsafe { isl_union_pw_qpolynomial_intersect_domain_wrapped_range(upwpq, uset) };
        if isl_rs_result == 0 {
            panic!("ISL error: {}", context_for_error_message.last_error_msg());
        }
        let isl_rs_result = UnionPwQPolynomial { ptr: isl_rs_result, should_free_on_drop: true };
    ...
    pub fn foreach_pw_qpolynomial<fn_>(&self, mut fn_: fn_, user: *mut c_void) -> Stat
    where fn_: FnMut(&PwQPolynomial) -> Stat,
    {
        let context_for_error_message = self.get_ctx();
        let upwqp = self;
        let upwqp = upwqp.ptr;
        ...
        let isl_rs_result = unsafe { isl_union_pw_qpolynomial_foreach_pw_qpolynomial(upwqp, fn_, user) };
        isl_rs_result
    }
    ...
    pub fn fold_add_union_pw_qpolynomial(upwf: UnionPwQPolynomialFold, upwqp: UnionPwQPolynomial) -> UnionPwQPolynomialFold {
        let mut upwf = upwf;
        upwf.do_not_free_on_drop();
        let upwf = upwf.ptr;
        let mut upwqp = upwqp;
    ...
    pub fn fold_intersect_domain(upwf: UnionPwQPolynomialFold, uset: UnionSet) -> UnionPwQPolynomialFold {
        let mut upwf = upwf;
        upwf.do_not_free_on_drop();
        let upwf = upwf.ptr;
        let mut uset = uset;
    ...
    pub fn fold_intersect_domain_wrapped_range(upwf: UnionPwQPolynomialFold, uset: UnionSet) -> UnionPwQPolynomialFold {
        let mut upwf = upwf;
        upwf.do_not_free_on_drop();
        let upwf = upwf.ptr;
        let mut uset = uset;
    ...
    pub fn intersect_domain_space(self, space: Space) -> UnionPwQPolynomial {
        ...
        space.do_not_free_on_drop();
        let space = space.ptr;
        let isl_rs_result = unsafe { isl_union_pw_qpolynomial_intersect_domain_space(upwpq, space) };
        if isl_rs_result == 0 {
            panic!("ISL error: {}", context_for_error_message.last_error_msg());
        }
        let isl_rs_result = UnionPwQPolynomial { ptr: isl_rs_result, should_free_on_drop: true };
    ...
    pub fn fold_foreach_pw_qpolynomial_fold<fn_>(upwf: &UnionPwQPolynomialFold, mut fn_: fn_, user: *mut c_void) -> Stat
    ...
    pub fn fold_extract_pw_qpolynomial_fold(upwf: &UnionPwQPolynomialFold, space: Space) -> PwQPolynomialFold {
        let upwf = upwf.ptr;
        let mut space = space;
        space.do_not_free_on_drop();
        let space = space.ptr;
    ...
    pub fn fold_plain_is_equal(upwf1: &UnionPwQPolynomialFold, upwf2: &UnionPwQPolynomialFold) -> bool {
        let upwf1 = upwf1.ptr;
        let upwf2 = upwf2.ptr;
    ...
    pub fn fold_set_dim_name(upwf: UnionPwQPolynomialFold, type_: DimType, pos: u32, s: &str) -> UnionPwQPolynomialFold {
        let mut upwf = upwf;
        upwf.do_not_free_on_drop();
        let upwf = upwf.ptr;
        let s = CString::new(s).unwrap();
    ...
    pub fn fold_intersect_domain_union_set(upwf: UnionPwQPolynomialFold, uset: UnionSet) -> UnionPwQPolynomialFold {
        let mut upwf = upwf;
        upwf.do_not_free_on_drop();
        let upwf = upwf.ptr;
        let mut uset = uset;
...
impl Drop for UnionPwQPolynomial {
    fn drop(&mut self) {
        if self.should_free_on_drop {
            unsafe { isl_union_pw_qpolynomial_free(self.ptr); }
        }
    }
}