...
use libc::uintptr_t;
use crate::bindings::{Stat, Set, Context};
...
extern "C" {
    ...
    fn isl_set_list_foreach(list: uintptr_t, fn_: unsafe extern "C" fn(uintptr_t, *mut c_void) -> Stat, user: *mut c_void) -> Stat;
    ...
    fn isl_set_list_every(list: uintptr_t, test: unsafe extern "C" fn(uintptr_t, *mut c_void) -> i32, user: *mut c_void) -> i32;
    ...
    fn isl_set_list_sort(list: uintptr_t, cmp: unsafe extern "C" fn(uintptr_t, uintptr_t, *mut c_void) -> i32, user: *mut c_void) -> uintptr_t;
    ...
    fn isl_set_list_map(list: uintptr_t, fn_: unsafe extern "C" fn(uintptr_t, *mut c_void) -> uintptr_t, user: *mut c_void) -> uintptr_t;
    ...
    fn isl_set_list_foreach_scc(list: uintptr_t, follows: unsafe extern "C" fn(uintptr_t, uintptr_t, *mut c_void) -> i32, follows_user: *mut c_void, fn_: unsafe extern "C" fn(uintptr_t, *mut c_void) -> Stat, fn_user: *mut c_void) -> Stat;
...
impl SetList {
    ...
    pub fn drop(self, first: u32, n: u32) -> SetList {
        ...
        let isl_rs_result = SetList { ptr: isl_rs_result, should_free_on_drop: true };
        isl_rs_result
    }
    ...
    pub fn sort<cmp>(self, mut cmp: cmp, user: *mut c_void) -> SetList
    ...
    pub fn map<fn_>(self, mut fn_: fn_, user: *mut c_void) -> SetList
          ...
          fn_: FnMut(&SetList) -> Stat,
    {
        ...
        let user: *mut c_void = unsafe { core::mem::transmute(user) };
        let fn_ = fn__wrapper::<fn_>;
        let isl_rs_result = unsafe { isl_set_list_foreach_scc(list, follows, follows_user, fn_, fn_user) };
        isl_rs_result
    }
...
impl Drop for SetList {
    fn drop(&mut self) {
        if self.should_free_on_drop {
            unsafe { isl_set_list_free(self.ptr); }
        }
    }
}