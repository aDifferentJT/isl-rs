...
use crate::bindings::{QPolynomialList, Val, Aff, PwMultiAffList, BasicMapList, BasicMap, MultiId, MultiUnionPwAff, ValList, Id, BasicSet, Map, PwAff, PwMultiAff, PwQPolynomialList, MultiVal, MapList, UnionSet, MultiPwAff, QPolynomial, IdList, AffList, UnionSetList, UnionPwAff, QPolynomialFold, UnionPwMultiAffList, UnionMap, UnionMapList, PwQPolynomialFold, Context, Set, PwQPolynomialFoldList, UnionPwMultiAff, UnionPwQPolynomialFold, UnionPwAffList, MultiAff, UnionPwQPolynomial, PwQPolynomial, PwAffList};
...
impl Printer {
    ...
    pub fn print_qpolynomial_list(self, list: &QPolynomialList) -> Printer {
        ...
        let isl_rs_result = Printer { ptr: isl_rs_result, should_free_on_drop: true };
        isl_rs_result
    }
...
impl Drop for Printer {
    fn drop(&mut self) {
        if self.should_free_on_drop {
            unsafe { isl_printer_free(self.ptr); }
        }
    }
}