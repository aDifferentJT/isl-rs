...
use crate::bindings::{Context, DimType, Id, Space, Val, ValList};
use libc::uintptr_t;
...
extern "C" {
    ...
    fn isl_multi_val_set_dim_id(multi: uintptr_t, type_: DimType, pos: u32, id: uintptr_t)
                                -> uintptr_t;
    ...
    fn isl_multi_val_find_dim_by_name(multi: uintptr_t, type_: DimType, name: *const c_char)
                                      -> i32;
    ...
    fn isl_multi_val_set_dim_name(multi: uintptr_t, type_: DimType, pos: u32, s: *const c_char)
                                  -> uintptr_t;
    ...
    fn isl_multi_val_insert_dims(multi: uintptr_t, type_: DimType, first: u32, n: u32)
                                 -> uintptr_t;
    ...
    fn isl_multi_val_set_tuple_name(multi: uintptr_t, type_: DimType, s: *const c_char)
                                    -> uintptr_t;
