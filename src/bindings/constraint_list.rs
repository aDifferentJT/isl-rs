...
impl ConstraintList {
    ...
    pub fn sort<cmp>(self, cmp: cmp, user: *mut c_void) -> ConstraintList
              ...
              fn_: FnMut(&ConstraintList) -> Stat
    {
        ...
        extern "C" fn fn__wrapper<fn_>(arg_0: uintptr_t, arg_1: *mut c_void) -> Stat
            where fn_: FnMut(&ConstraintList) -> Stat
        {
            if arg_0 == 0 {
                panic!("ISL error");
            }
            let arg_0 = &ConstraintList { ptr: arg_0,
                                          should_free_on_drop: true };
            let fn_: *mut fn_ = unsafe { core::mem::transmute(arg_1) };
            let fn_: &mut fn_ = unsafe { &mut *fn_ };
            let res = fn_(arg_0);
    ...
    pub fn map<fn_>(self, fn_: fn_, user: *mut c_void) -> ConstraintList
