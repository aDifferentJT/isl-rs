...
use crate::bindings::{
    Context, DimType, Fold, Point, PwQPolynomialFold, PwQPolynomialFoldList, Set, Space, Stat,
...
impl UnionPwQPolynomialFold {
    ...
    pub fn foreach_pw_qpolynomial_fold<fn_>(&self, fn_: fn_, user: *mut c_void) -> Stat
    ...
    pub fn every_pw_qpolynomial_fold<test>(&self, test: test, user: *mut c_void) -> bool
