...
impl PwQPolynomial {
    ...
    pub fn fold_list_map(list: PwQPolynomialFoldList,
    ...
    pub fn fold_list_foreach_scc(list: &PwQPolynomialFoldList,
                                 follows: unsafe extern "C" fn(uintptr_t,
                                                      uintptr_t,
                                                      *mut c_void)
                                                      -> i32,
    ...
    pub fn fold_foreach_piece(pwf: &PwQPolynomialFold,
                              fn_: unsafe extern "C" fn(uintptr_t,
                                                   uintptr_t,
                                                   *mut c_void)
                                                   -> Stat,
    ...
    pub fn fold_list_sort(list: PwQPolynomialFoldList,
    ...
    pub fn fold_foreach_lifted_piece(pwf: &PwQPolynomialFold,
                                     fn_: unsafe extern "C" fn(uintptr_t,
                                                          uintptr_t,
                                                          *mut c_void)
                                                          -> Stat,
    ...
    pub fn fold_list_every(list: &PwQPolynomialFoldList,
    ...
    pub fn fold_every_piece(pwf: &PwQPolynomialFold,
    ...
    pub fn foreach_lifted_piece(&self,
                                fn_: unsafe extern "C" fn(uintptr_t,
                                                     uintptr_t,
                                                     *mut c_void)
                                                     -> Stat,
    ...
    pub fn fold_list_foreach(list: &PwQPolynomialFoldList,
                             fn_: unsafe extern "C" fn(uintptr_t, *mut c_void) -> Stat,
                             user: *mut c_void)
                             -> Stat {
        let list = list.ptr;
