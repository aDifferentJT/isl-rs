...
use libc::uintptr_t;
use crate::bindings::{DimType, Stat, Fold, PwQPolynomialFoldList, PwQPolynomialFold, Id, Space, Set, QPolynomial, UnionPwQPolynomial, PwAff, Val, Context, Point, PwQPolynomialList, QPolynomialFold, UnionPwQPolynomialFold};
...
extern "C" {
    ...
    fn isl_pw_qpolynomial_drop_dims(pwqp: uintptr_t, type_: DimType, first: u32, n: u32) -> uintptr_t;
    ...
    fn isl_pw_qpolynomial_split_dims(pwqp: uintptr_t, type_: DimType, first: u32, n: u32) -> uintptr_t;

    fn isl_pw_qpolynomial_fold_fix_val(pwf: uintptr_t, type_: DimType, n: u32, v: uintptr_t) -> uintptr_t;

    fn isl_pw_qpolynomial_fold_list_foreach_scc(list: uintptr_t, follows: unsafe extern "C" fn(uintptr_t, uintptr_t, *mut c_void) -> i32, follows_user: *mut c_void, fn_: unsafe extern "C" fn(uintptr_t, *mut c_void) -> Stat, fn_user: *mut c_void) -> Stat;

    fn isl_pw_qpolynomial_move_dims(pwqp: uintptr_t, dst_type: DimType, dst_pos: u32, src_type: DimType, src_pos: u32, n: u32) -> uintptr_t;
    ...
    fn isl_pw_qpolynomial_insert_dims(pwqp: uintptr_t, type_: DimType, first: u32, n: u32) -> uintptr_t;
    ...
    fn isl_pw_qpolynomial_find_dim_by_name(pwqp: uintptr_t, type_: DimType, name: *const c_char) -> i32;

    fn isl_pw_qpolynomial_min(pwqp: uintptr_t) -> uintptr_t;

    fn isl_pw_qpolynomial_fold_list_get_pw_qpolynomial_fold(list: uintptr_t, index: i32) -> uintptr_t;
    ...
    fn isl_pw_qpolynomial_fold_list_sort(list: uintptr_t, cmp: unsafe extern "C" fn(uintptr_t, uintptr_t, *mut c_void) -> i32, user: *mut c_void) -> uintptr_t;

    fn isl_pw_qpolynomial_foreach_piece(pwqp: uintptr_t, fn_: unsafe extern "C" fn(uintptr_t, uintptr_t, *mut c_void) -> Stat, user: *mut c_void) -> Stat;
    ...
    fn isl_pw_qpolynomial_involves_dims(pwqp: uintptr_t, type_: DimType, first: u32, n: u32) -> i32;
    ...
    fn isl_pw_qpolynomial_fold_list_foreach(list: uintptr_t, fn_: unsafe extern "C" fn(uintptr_t, *mut c_void) -> Stat, user: *mut c_void) -> Stat;
    ...
    fn isl_pw_qpolynomial_every_piece(pwqp: uintptr_t, test: unsafe extern "C" fn(uintptr_t, uintptr_t, *mut c_void) -> i32, user: *mut c_void) -> i32;
    ...
    fn isl_pw_qpolynomial_intersect_domain_wrapped_range(pwpq: uintptr_t, set: uintptr_t) -> uintptr_t;
    ...
    fn isl_pw_qpolynomial_fix_val(pwqp: uintptr_t, type_: DimType, n: u32, v: uintptr_t) -> uintptr_t;

    fn isl_pw_qpolynomial_fold_list_set_pw_qpolynomial_fold(list: uintptr_t, index: i32, el: uintptr_t) -> uintptr_t;
    ...
    fn isl_pw_qpolynomial_fold_list_every(list: uintptr_t, test: unsafe extern "C" fn(uintptr_t, *mut c_void) -> i32, user: *mut c_void) -> i32;

    fn isl_pw_qpolynomial_fold_list_map(list: uintptr_t, fn_: unsafe extern "C" fn(uintptr_t, *mut c_void) -> uintptr_t, user: *mut c_void) -> uintptr_t;
    ...
    fn isl_pw_qpolynomial_foreach_lifted_piece(pwqp: uintptr_t, fn_: unsafe extern "C" fn(uintptr_t, uintptr_t, *mut c_void) -> Stat, user: *mut c_void) -> Stat;
    ...
    fn isl_pw_qpolynomial_set_dim_name(pwqp: uintptr_t, type_: DimType, pos: u32, s: *const c_char) -> uintptr_t;
    ...
    fn isl_pw_qpolynomial_intersect_domain_wrapped_domain(pwpq: uintptr_t, set: uintptr_t) -> uintptr_t;
...
impl PwQPolynomial {
    ...
    pub fn fold_list_foreach_scc<follows, fn_>(list: &PwQPolynomialFoldList, mut follows: follows, follows_user: *mut c_void, mut fn_: fn_, fn_user: *mut c_void) -> Stat
          ...
          fn_: FnMut(&PwQPolynomialFoldList) -> Stat,
    {
        ...
        let isl_rs_result = unsafe { isl_pw_qpolynomial_fold_list_foreach_scc(list, follows, follows_user, fn_, fn_user) };
        isl_rs_result
    }
    ...
    pub fn move_dims(self, dst_type: DimType, dst_pos: u32, src_type: DimType, src_pos: u32, n: u32) -> PwQPolynomial {
        ...
        pwqp.do_not_free_on_drop();
        let pwqp = pwqp.ptr;
        let isl_rs_result = unsafe { isl_pw_qpolynomial_move_dims(pwqp, dst_type, dst_pos, src_type, src_pos, n) };
        if isl_rs_result == 0 {
            panic!("ISL error: {}", context_for_error_message.last_error_msg());
        }
        let isl_rs_result = PwQPolynomial { ptr: isl_rs_result, should_free_on_drop: true };
    ...
    pub fn fold_foreach_piece<fn_>(pwf: &PwQPolynomialFold, mut fn_: fn_, user: *mut c_void) -> Stat
    ...
    pub fn fold_list_get_pw_qpolynomial_fold(list: &PwQPolynomialFoldList, index: i32) -> PwQPolynomialFold {
        let list = list.ptr;
        let isl_rs_result = unsafe { isl_pw_qpolynomial_fold_list_get_pw_qpolynomial_fold(list, index) };
        if isl_rs_result == 0 {
            panic!("ISL error");
        }
        let isl_rs_result = PwQPolynomialFold { ptr: isl_rs_result, should_free_on_drop: true };
    ...
    pub fn fold_list_sort<cmp>(list: PwQPolynomialFoldList, mut cmp: cmp, user: *mut c_void) -> PwQPolynomialFoldList
    ...
    pub fn as_qpolynomial(self) -> QPolynomial {
        ...
        let isl_rs_result = QPolynomial { ptr: isl_rs_result, should_free_on_drop: true };
        isl_rs_result
    }
    ...
    pub fn fold_every_piece<test>(pwf: &PwQPolynomialFold, mut test: test, user: *mut c_void) -> bool
    ...
    pub fn fold_list_foreach<fn_>(list: &PwQPolynomialFoldList, mut fn_: fn_, user: *mut c_void) -> Stat
    ...
    pub fn fold_foreach_lifted_piece<fn_>(pwf: &PwQPolynomialFold, mut fn_: fn_, user: *mut c_void) -> Stat
    where fn_: FnMut(&Set, &QPolynomialFold) -> Stat,
    {
        let pwf = pwf.ptr;
        extern "C" fn fn__wrapper<fn_>(arg_0: uintptr_t, arg_1: uintptr_t, arg_2: *mut c_void) -> Stat {
    ...
    pub fn fold_list_set_pw_qpolynomial_fold(list: PwQPolynomialFoldList, index: i32, el: PwQPolynomialFold) -> PwQPolynomialFoldList {
        ...
        el.do_not_free_on_drop();
        let el = el.ptr;
        let isl_rs_result = unsafe { isl_pw_qpolynomial_fold_list_set_pw_qpolynomial_fold(list, index, el) };
        if isl_rs_result == 0 {
            panic!("ISL error");
        }
        let isl_rs_result = PwQPolynomialFoldList { ptr: isl_rs_result, should_free_on_drop: true };
    ...
    pub fn fold_list_every<test>(list: &PwQPolynomialFoldList, mut test: test, user: *mut c_void) -> bool
    ...
    pub fn fold_list_map<fn_>(list: PwQPolynomialFoldList, mut fn_: fn_, user: *mut c_void) -> PwQPolynomialFoldList
    ...
    pub fn intersect_domain_wrapped_domain(self, set: Set) -> PwQPolynomial {
        ...
        set.do_not_free_on_drop();
        let set = set.ptr;
        let isl_rs_result = unsafe { isl_pw_qpolynomial_intersect_domain_wrapped_domain(pwpq, set) };
        if isl_rs_result == 0 {
            panic!("ISL error: {}", context_for_error_message.last_error_msg());
        }
        let isl_rs_result = PwQPolynomial { ptr: isl_rs_result, should_free_on_drop: true };
...
impl Drop for PwQPolynomial {
    fn drop(&mut self) {
        if self.should_free_on_drop {
            unsafe { isl_pw_qpolynomial_free(self.ptr); }
        }
    }
}