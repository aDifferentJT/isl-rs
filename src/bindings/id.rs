...
use crate::bindings::{IdList, Context};
...
extern "C" {
    ...
    fn isl_id_set_free_user(id: uintptr_t, free_user: unsafe extern "C" fn(*mut c_void)) -> uintptr_t;
...
impl Id {
    ...
    pub fn set_free_user<free_user>(self, mut free_user: free_user) -> Id
