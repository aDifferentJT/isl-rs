...
use crate::bindings::{Context, Stat, UnionMap};
use libc::uintptr_t;
...
extern "C" {
    ...
    fn isl_union_map_list_foreach(list: uintptr_t,
    ...
    fn isl_union_map_list_map(list: uintptr_t,
                              fn_: unsafe extern "C" fn(uintptr_t, *mut c_void) -> uintptr_t,
                              user: *mut c_void)
                              -> uintptr_t;

    fn isl_union_map_list_sort(list: uintptr_t,
    ...
    fn isl_union_map_list_foreach_scc(list: uintptr_t,
    ...
    fn isl_union_map_list_every(list: uintptr_t,
...
impl UnionMapList {
    ...
    pub fn map<fn_>(self, fn_: fn_, user: *mut c_void) -> UnionMapList
    ...
    pub fn sort<cmp>(self, cmp: cmp, user: *mut c_void) -> UnionMapList
              ...
              fn_: FnMut(&UnionMapList) -> Stat
    {
        ...
        extern "C" fn fn__wrapper<fn_>(arg_0: uintptr_t, arg_1: *mut c_void) -> Stat
            where fn_: FnMut(&UnionMapList) -> Stat
        {
            if arg_0 == 0 {
                panic!("ISL error");
            }
            let arg_0 = &UnionMapList { ptr: arg_0,
                                        should_free_on_drop: true };
            let fn_: *mut fn_ = unsafe { core::mem::transmute(arg_1) };
            let fn_: &mut fn_ = unsafe { &mut *fn_ };
            let res = fn_(arg_0);
        ...
        let fn_ = fn__wrapper::<fn_>;
        let isl_rs_result =
            unsafe { isl_union_map_list_foreach_scc(list, follows, follows_user, fn_, fn_user) };
        isl_rs_result
    }
